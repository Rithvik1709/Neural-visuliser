...
class FeedForwardModel {
  ...
  throw new Error("The network definition must contain layers.");
    }
...
class NetworkInfoPanel {
  ...
  this.summaryElement.appendChild(this.buildSummaryLine("Layers (incl. outputs)", layerSummaries.length));
      ...
      <div class="neuron-detail-panel__inner">
        ...
        <div class="neuron-detail-panel__body">
          ...
          <div class="neuron-detail-panel__activations">
            <span>Previous layer size: ${payload.previousLayerSize ?? "—"}</span>
            <span>Next layer size: ${payload.nextLayerSize ?? "—"}</span>
          </div>
          ${incomingSection}
          ${outgoingSection}
        </div>
